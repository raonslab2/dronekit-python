...
if __name__ == "__main__":
    ...
    db_host = db_config.get('host', '13.209.238.3')
    db_user = db_config.get('user', 'mrdev')
    db_password = db_config.get('password', 'mrdev1')
    db_database = db_config.get('database', 'sepm_db')
